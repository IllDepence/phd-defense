...
\section{Motivation}
       ...
       \column{.575\textwidth}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item ML models (LLMs, sumarization, recommender systems) % PILE, S2ORC, unarXive, ...)
   ...
   \end{overprint}
    ...
    \centering
   \only<3>{
        {\Large\textbf{better maps\footnote{Abstract representations of the real world} $\Rightarrow$ better decisions}}
   }
   \only<4>{
        {\Large\textbf{false maps $\Rightarrow$ misleading/false analyses, models, etc.}}
   }
   \only<5>{
        {\Large\textbf{our maps of science are insufficient\footnote{Used data sets are small, incomplete, noisy, etc.}}}
   }
   \only<6>{
       \begin{infobox-objective}
       \Large\textbf{Research Objective}\\Develop methods for generating high-quality scholarly data.
...
\section{Outline}
   ...
   \begin{frame}[plain]
       \begin{overprint}
           ...
           \onslide<2> \centering\includegraphics[width=\textwidth]{imgs/objective_grid_and_contrib_1}
...
\section{Artifact Parameters}
   ...
   %     \column{.575\textwidth}
    \begin{itemize}
        ...
        \end{itemize}
        \item $\rightarrow$ \textbf{RT4} $\checkmark$
    \end{itemize}
       % \column{.475\textwidth}
       %    \centering
   % \end{columns}
...
\section{Conclusion}
   ...
   \begin{frame}[plain]
       \begin{overprint}
           ...
           \onslide<2> \centering\includegraphics[width=\textwidth]{imgs/objective_grid_and_contrib_conclusion}
       \end{overprint}
   \end{frame}
   ...
   \begin{columns}
       ...
       \column{.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{imgs/contrib_overview_dis_var}
   \end{columns}
   \end{frame}
