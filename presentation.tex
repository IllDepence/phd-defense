...
\section{Background}
   ...
   \begin{frame}[plain]
       \begin{overprint}
           ...
           \onslide<1> \centering\includegraphics[width=\textwidth]{imgs/objective_dq_grid}
       \end{overprint}
   \end{frame}
...
\section{Outline}
   ...
   \begin{frame}[plain]
       \vspace{1.25cm}
       \begin{overprint}
           \onslide<1> \centering\includegraphics[width=0.85\textwidth]{imgs/contrib_overview_dis_var}
           \onslide<2> \centering\includegraphics[width=0.85\textwidth]{imgs/contrib_overview_dis_var_sel}
       \end{overprint}
   \end{frame}
   ...
   \begin{columns}
       \column{.3\textwidth}
           ...
           \end{itemize}
       \column{.575\textwidth}
            \includegraphics[width=\linewidth]{imgs/contrib_overview_dis_var_sel}
   \end{columns}
   \end{frame}
