...
\section{Background}
   ...
   \begin{frame}{Research Gap}
       \begin{overprint}
           ...
           \onslide<1> \centering\includegraphics[width=0.55\textwidth]{imgs/schema_add_09}
           % - Gap: Citation Network
           % - Vis: Doc A to question mark
           % - Importance: prevalent use cases hinge on cn
           \onslide<2> \centering\includegraphics[width=0.55\textwidth]{imgs/schema_add_09}
           % - Gap: Anglocentrism
           % - Vis: Doc 文 and refsecentry first 文字化け, then disappear
           % - Importance: science is a global = multi-lingual endeavor
           \onslide<3> \centering\includegraphics[width=0.55\textwidth]{imgs/schema_add_09}
...
\section{Parameters}
   ...
   \begin{frame}{Parameters}
       \begin{overprint}
           \onslide<1> \centering\includegraphics[width=0.4\textwidth]{imgs/schema_asp_3_0}
           \onslide<2> \centering\includegraphics[width=0.4\textwidth]{imgs/schema_asp_3_1}
       \end{overprint}
   \end{frame}
