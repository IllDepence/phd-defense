...
% - check readability of examples (too small/dark/...)
% - add outlook slide
% - corpus tables: link scc. acc, mby use prec/rec/..
% - slide 35/36 -> too much information not rly digestible in a short time.
       ...
       \column{.575\textwidth}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Joint handling of text + references  % able to link citation markers
       ...
       \column{.575\textwidth}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Visual medium \& assumed background knowledge  % Bridging visual medium and text information  % (e.g. footnotes: how to incorporate? Special syntax? Keep LaTeX as is? -- what about bold and italic text? Keep? ...)
            \end{itemize}
            \item \textbf{Parsing}
            \begin{itemize}
                \item Parser efficiency
                \item Typesetting info $\neq$ semantic info % {\color{contextgrey}()}
...
\section{Artifact Parameters}
   ...
   \begin{columns}
       \column{.475\textwidth}
           \begin{itemize}
               \item Fine-tuned Models
                   \begin{itemize}
                       \item SciERC dataset~\cite{luan2018scierc} % (paragraph level)
       ...
       \column{.475\textwidth}
          \begin{overprint}
              \onslide<1> \centering\includegraphics[width=\textwidth]{imgs/scirex}
              \onslide<2> \centering\includegraphics[width=0.9\textwidth]{imgs/llm_sciext}
          \end{overprint}
   \end{columns}
   \end{frame}
   ...
   \begin{columns}
       ...
       \column{.575\textwidth}
        ...
        \only<2>{
           \vspace{0.5em}
           \centering\includegraphics[width=0.5\linewidth]{imgs/hyperpie_results_bert}
        }
        % \only<3>{
        % \vspace{1.5em}
        % \begin{table}
   ...
   \begin{columns}
       ...
       \column{.575\textwidth}
        ...
        \only<2>{
           \vspace{0.25em}
           \centering\includegraphics[width=\linewidth]{imgs/hyperpie_results_llm}
        }
        %\only<3>{
...
% make sound positive (what further stuff does my research *enable*)
   ...
   \begin{columns}
       ...
       \column{.6\textwidth}
          \begin{overprint}
              \onslide<1> \includegraphics[width=\textwidth]{imgs/outlook_0}
              \onslide<2> \includegraphics[width=\textwidth]{imgs/outlook_1}
              \onslide<3> \includegraphics[width=\textwidth]{imgs/outlook_2}
              \onslide<4> \includegraphics[width=\textwidth]{imgs/outlook_3}
              \onslide<5> \includegraphics[width=\textwidth]{imgs/outlook_4}
              \onslide<6> \includegraphics[width=\textwidth]{imgs/outlook_5}
          \end{overprint}
   \end{columns}
   \end{frame}
...
% TODO: add JCDL paper figs (CS rising + increasing cit density)
