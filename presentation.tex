...
\section{Outline}
   ...
   \begin{frame}[plain]
       \vspace{1.25cm}
       \begin{overprint}
           \onslide<1> \centering\includegraphics[width=0.85\textwidth]{imgs/contrib_overview_v1}
           \onslide<2> \centering\includegraphics[width=0.85\textwidth]{imgs/contrib_overview_v1_sel}
       \end{overprint}
   \end{frame}
