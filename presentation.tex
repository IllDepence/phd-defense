...
\section{Background}
   ...
   \begin{frame}
       \frametitle<1-2>{Research Gap: Citations}
       \frametitle<3-6>{Research Gap: Non-English}
       \frametitle<7-8>{Research Gap: Artifacts}
       \begin{overprint}
           % TODO: visualize research gaps
...
\section{Outline}
   ...
   \begin{frame}[plain]
       \begin{overprint}
           % TODO: make stuff appear one by one, replace D_n's w/ icons
   ...
   \begin{columns}
       \column{.575\textwidth}
           \begin{itemize}
               % \item \textbf{Data}
               % \begin{itemize}
               %     \item papers from ML, CL, CV, DL
               %     % \item manual annotation
               %     % \item sped up by automated pre-annotation
               % \end{itemize}
